    ...
    static class MaterialUtility
    {
        ...
        public static Material defaultMaterial
        {
            get
            {
                ...
                {
                    s_DefaultMaterial = renderPipeline.defaultMaterial;
                }
        ...
        public static Material FixPaperMaterial(Material material)
        {
            if (material == null) return BookResources.defaultPaperMaterial;

            return material;
        }

        public static Material FixMetalMaterial(Material material)
        {
            if (material == null) return BookResources.defaultMetalMaterial;
